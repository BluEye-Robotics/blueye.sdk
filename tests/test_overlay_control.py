...
@pytest.mark.parametrize("mocked_drone", ["1.7.60"], indirect=True)
class TestOverlay(OverlayTestBase):
...
@pytest.mark.parametrize("mocked_drone", ["1.8.72"], indirect=True)
class TestOverlayLogoControl(OverlayTestBase):
